...
tag: dev
summary: "SOPS를 활용한 secret 관리 경험을 공유합니다."
---
...
[SOPS](https://github.com/getsops/sops)는 Cloud Native Computing Foundation 샌드박스 프로젝트 중 하나로, yaml, json, env, ini, 그리고 그 외 여러 포맷들을 지원하는 암호화 파일 에디터입니다.
